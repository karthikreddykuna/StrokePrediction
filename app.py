...
tpot_data = pd.read_csv('https://raw.githubusercontent.com/karthikreddykuna/StrokePrediction/main/prepared_data.csv')
features = tpot_data.drop('target', axis=1)
training_features, testing_features, training_target, testing_target = \
            train_test_split(features, tpot_data['target'], random_state=None)

# Average CV score on the training set was: 0.9515658994532444
exported_pipeline = GradientBoostingClassifier(learning_rate=0.1, max_depth=1, max_features=0.3, min_samples_leaf=10, min_samples_split=5, n_estimators=100, subsample=0.8)
...
encoder_location = 'https://github.com/karthikreddykuna/StrokePrediction/blob/main/encoder.pkl?raw=true'
